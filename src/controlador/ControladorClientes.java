...
public class ControladorClientes implements ActionListener, MouseListener, KeyListener{
    ...
    public ControladorClientes(Clientes cl, ClientesDao clDao, PanelAdmin views) {
        this.cl = cl;
        this.clDao = clDao;
        this.views = views;
        this.views.btnRegitrarCli.addActionListener(this);
        ...
        this.views.JMenuElimnarCli.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btnRegitrarCli) {
        ...
        }else if(e.getSource() == views.JMenuElimnarCli){
            if (views.txtIdCli.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Selecciona una fila");
            }else{
